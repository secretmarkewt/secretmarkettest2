...
const routes = ["/", "/catalog", "/catalog/roblox", "/product/12345", "/seller/pixeltrade", "/auth", "/checkout", "/payment/order-id", "/payment/12345", "/payment/33412", "/orders/12345", "/orders/22341", "/orders/33412", "/orders/77102", "/chats", "/notifications", "/account", "/account/orders", "/account/favorites", "/account/reviews", "/account/payments", "/seller", "/seller/profile", "/seller/products", "/seller/products/create", "/seller/orders", "/seller/finance", "/seller/withdraw", "/seller/settings", "/disputes", "/support", "/support/faq", "/support/ticket", "/support/requests", "/support/payment", "/support/order", "/support/seller", "/terms", "/privacy", "/contacts", "/faq", "/status-map", "/crypto-payment-guide", "/refund-policy", "/seller-rules", "/buyer-rules", "/fees", "/admin", "/admin/users", "/admin/sellers", "/admin/products", "/admin/orders", "/admin/payments", "/admin/payouts", "/admin/disputes", "/admin/tickets", "/admin/categories", "/admin/promocodes", "/admin/fees", "/admin/crypto", "/admin/moderation"];
...
(async () => {
  ...
  for (const route of routes) {
    ...
    if (response.status !== 200 || !text.includes('id="app"') || !text.includes("app.js")) {
